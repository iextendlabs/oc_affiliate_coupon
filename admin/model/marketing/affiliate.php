...
class ModelMarketingAffiliate extends Model {
	public function getCustomerCommissionTransactions($affiliate_id, $order_status_id, $filter_month='', $filter_year='') {
					
		$query = "SELECT order_id, order_status_id, affiliate_id , commission, date_added, date_modified FROM " . DB_PREFIX . "order  WHERE affiliate_id = '" . (int)$affiliate_id . "' AND order_status_id = '" . (int)$order_status_id . "' ";
	...
	public function getCustomerTransactionTotal($affiliate_id, $order_status_id) {
		$query = $this->db->query("SELECT SUM(commission) AS total FROM " . DB_PREFIX . "order  WHERE affiliate_id = '" . (int)$affiliate_id . "' AND order_status_id = '" . (int)$order_status_id . "'");
