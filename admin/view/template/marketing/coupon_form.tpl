          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
                  <div class="form-group">
		                <label class="col-sm-2 control-label" for="input-types"><?php echo $column_affliate; ?></label>
		                <div class="col-sm-10">
		                  <select name="affiliate_id" id="input-types" class="form-control">
		                    <option value="0"><?php echo $text_no_affiliate; ?></option>
		                    <?php if ($customer_affiliates != '') { ?>
                          <?php foreach ($customer_affiliates as $customer_affiliates) { ?>
		                        <option value="<?php echo $customer_affiliates['affiliate_id'];?>" <?php if ($customer_affiliates['affiliate_id'] == $affiliate_id) { ?> selected <?php } ?> > <?php echo $customer_affiliates['firstname'] .' '. $customer_affiliates['lastname']; ?> </option>
		                      <?php } ?>
		                    <?php } ?>
		                  </select>
		                </div>
		              ...
		              <div class="form-group">
		                <label class="col-sm-2 control-label" for="input-commission"><?php echo $column_commission; ?></label>
		                <div class="col-sm-10">
		                  <input type="text" name="affiliate_commission" value="<?php echo $affiliate_commission; ?>" placeholder="<?php echo $column_commission; ?>" id="input-commission" class="form-control" />
		                </div>
		              </div>
